...
def getVerbs(json_file):
    ...
    for obj in objs:
        ret[obj] = json_file[json_file['coco_class'] == obj]['verb'].unique()
...
if __name__ == '__main__':
    ...
    output_file['Train_verbs'] = getVerbs(trainval_json_file)
    # print(getVerbCounts(trainval_json_file))
    # print(getVerbs(trainval_json_file))
